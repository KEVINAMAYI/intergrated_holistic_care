        ...
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="about_content">
                        <div class="about_title"><a style="color:rgb(27, 184, 191);"
                                                    href="{{ route('student-courses.index') }}">Professional Caregiving
                                Course</a></div>
            ...
            <div class="row about_row row-lg-eq-height">
                ...
                <div class="col-lg-6 order-lg-2 order-1">
                    <div class="about_content">
                        <div class="about_title"><a style="color:rgb(27, 184, 191);"
                                                    href="{{ route('student-courses.index') }}">First Aid/CPR
                                training</a></div>
                        <div class="about_text">
            ...
            <div class="row about_row row-lg-eq-height">
                <div class="col-lg-6">
                    <div class="about_content">
                        <div class="about_title"><a style="color:rgb(27, 184, 191);"
                                                    href="{{ route('student-courses.index') }}">Comprehensive Homecare
                                Services</a></div>
                        <div class="about_text">
            ...
            <div class="row about_row row-lg-eq-height">
                ...
                <div class="col-lg-6 order-lg-2 order-1">
                    <div class="about_content">
                        <div class="about_title"><a style="color:rgb(27, 184, 191);"
                                                    href="{{ route('student-courses.index') }}">Local and Oversea Job
                                referrals</a></div>
                        <div class="about_text">
