                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{ route('student-profile.index') }}" class="nav-link">
                            <i style="color: rgb(27, 184, 191);" class="nav-icon fa fa-user"></i>
                            <p style="font-weight:bold; color: rgb(27, 184, 191);">Profile</p>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('student-enrolled-courses.index') }}" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('student-finances.index') }}" class="nav-link">
                            <i style="color: rgb(27, 184, 191);" class="nav-icon fa fa-dollar-sign"></i>
                            <p style="font-weight:bold; color: rgb(27, 184, 191);">Finances</p>
                        </a>
                    </li>
