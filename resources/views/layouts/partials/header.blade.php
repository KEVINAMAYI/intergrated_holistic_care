                    ...
                    <div class="col">
                        <div class="header_content d-flex flex-row align-items-center justify-content-start">
                            <div class="logo_container pb-3">
                                <a href="#">
                                    <div class="logo_content">
                                        ...
                                        <div class="logo_text pb-3" style="text-align:center; color:rgb(27,184,191);">CARE
                                        </div>
                                    </div>
                            ...
                            <nav class="main_nav_contaner ml-auto">
                                <ul class="main_nav">
                                    <li class="{{ Route::is('home.index') ? 'active' : '' }}"><a href="{{ route('home.index') }}">home</a></li>
                                    <li class="{{ Route::is('about.index') ? 'active' : '' }}"><a href="{{ route('about.index') }}">about us</a></li>
                                    <li class="{{ Route::is('services.index') ? 'active' : '' }}"><a href="{{ route('services.index') }}">services</a></li>
                                    <!-- <li><a href="courses.html">courses</a></li>
                                    <li><a href="news.html">news</a></li> -->
                                    <li class="{{ Route::is('contact.index') ? 'active' : '' }}"><a href="{{ route('contact.index') }}">contact</a></li>
                                </ul>
